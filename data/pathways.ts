...
// Do not reuse one generic clip across several different progressions. Videos
// are added exercise by exercise as they are reviewed or recorded.
const noVideoYet = '';
const squatVideo = noVideoYet;
...
const originalPathways: Pathway[] = [
  {
    ...
    levels: [
      ...
      level('split-squat', 'Split squat', 'Build single-leg strength from a stable staggered stance.', 'Complete eight controlled repetitions per side.', exercise({ id: 'split-squat', title: 'Split squat', purpose: 'Build unilateral leg strength while both feet remain grounded.', sets: 3, reps: '6–10 / side', cues: ['Choose a stance that feels stable.', 'Lower both knees without rushing.', 'Press through the front foot to stand.'], videoId: squatVideo })),
      level('assisted-bulgarian-split-squat', 'Assisted Bulgarian split squat', 'Elevate the rear foot and use hand support to control the new balance demand.', 'Complete six steady repetitions per side.', exercise({ id: 'assisted-bulgarian-split-squat', title: 'Assisted Bulgarian split squat', purpose: 'Prepare rear-foot-elevated single-leg strength with reliable support.', equipment: ['chair', 'box-bench'], sets: 3, reps: '4–8 / side', cues: ['Use a stable rear-foot support.', 'Keep one hand on a secure support.', 'Choose a depth you can reverse smoothly.'], videoId: squatVideo })),
      level('bulgarian-split-squat', 'Bulgarian split squat', 'Build strong unilateral legs with the rear foot elevated.', 'Complete ten controlled repetitions per side.', exercise({ id: 'bulgarian-split-squat', title: 'Bulgarian split squat', purpose: 'Develop single-leg strength and pelvic control through a split stance.', equipment: ['box-bench'], sets: 3, reps: '6–12 / side', cues: ['Set the rear foot on a stable surface.', 'Let the front leg do most of the work.', 'Keep the pelvis steady as you stand.'], videoId: squatVideo })),
      level('supported-lateral-squat', 'Supported lateral squat', 'Shift into one leg at a time while the hands help with balance and range.', 'Complete six smooth shifts per side.', exercise({ id: 'supported-lateral-squat', title: 'Supported lateral squat', purpose: 'Introduce side-to-side leg strength with adjustable support.', equipment: ['chair'], sets: 3, reps: '5–8 / side', cues: ['Hold a stable support in front of you.', 'Bend one knee while the other leg lengthens.', 'Keep both feet connected to the floor.'], videoId: squatVideo })),
      level('assisted-cossack-squat', 'Assisted Cossack squat', 'Use hand support to explore a deeper lateral squat.', 'Complete five controlled repetitions per side.', exercise({ id: 'assisted-cossack-squat', title: 'Assisted Cossack squat', purpose: 'Build active strength through a wide side-to-side range.', equipment: ['chair'], sets: 3, reps: '3–6 / side', cues: ['Use generous hand support.', 'Sit towards one heel while the other leg lengthens.', 'Turn the straight-leg toes up only if that feels natural.'], videoId: squatVideo })),
      level('cossack-squat', 'Cossack squat', 'Move into a deep lateral squat with active control and no hand support.', 'Complete five calm repetitions per side.', exercise({ id: 'cossack-squat', title: 'Cossack squat', purpose: 'Combine lateral leg strength, balance and active inner-thigh range.', sets: 3, reps: '3–6 / side', cues: ['Shift slowly towards one side.', 'Keep the working foot grounded.', 'Use only the depth you can leave without momentum.'], caution: 'Reduce the range if the knee, groin or ankle feels strained.', videoId: squatVideo })),
      level('cossack-transitions', 'Controlled Cossack transitions', 'Move smoothly from one lateral squat to the other without standing fully.', 'Complete four controlled transitions in each direction.', exercise({ id: 'cossack-transitions', title: 'Controlled Cossack transitions', purpose: 'Make lateral strength and mobility usable from side to side.', sets: 3, reps: '3–5 / side', cues: ['Stay as high as needed to keep control.', 'Transfer weight through the centre slowly.', 'Let both feet adjust naturally as you move.'], caution: 'Do not force a low transition before each side is comfortable on its own.', videoId: squatVideo })),
    ],
    branches: [
      { id: 'bilateral-foundation', title: 'Squat foundation', description: 'Build confident two-leg strength and controlled depth.', primary: true, levelIds: ['supported-sit-to-stand', 'chair-squat', 'supported-deep-squat', 'bodyweight-squat', 'tempo-squat'] },
      { id: 'unilateral-strength', title: 'Unilateral leg strength', description: 'Progress from a stable split stance towards a controlled pistol squat.', levelIds: ['split-squat', 'assisted-bulgarian-split-squat', 'bulgarian-split-squat', 'assisted-single-leg-squat', 'box-pistol-squat', 'assisted-pistol-squat', 'pistol-squat'] },
      { id: 'lateral-strength', title: 'Lateral strength and mobility', description: 'Build active side-to-side range through supported and free Cossack squats.', relatedPathwayIds: ['middle-split', 'resting-squat'], levelIds: ['supported-lateral-squat', 'assisted-cossack-squat', 'cossack-squat', 'cossack-transitions'] },
    ],
    assessment: [
